...
function shootBullet() {
    ...
    if (soDan > 0) {
        ...
        bullet.style.backgroundColor = "rgb(100, 100, 200)";
...
function updateLightBeamCooldown(time) {
    ...
    if (cooldownDisplay) {
        cooldownDisplay.innerHTML = `<img src="minji2.webp" alt="Hồi chiêu" id="hinh-anh" style="vertical-align: middle;"> ${time}s`;
    }
}
...
function createLightBeam() {
    ...
    lightBeam.style.width = character.offsetWidth + 20 + "px";
    lightBeam.style.height = character.offsetHeight + 20 + "px";
    lightBeam.style.backgroundImage = "url('minji2.webp')";
