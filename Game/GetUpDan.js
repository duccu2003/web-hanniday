...
function shootBullet() {
    ...
    if (soDan > 0) {
        ...
        bullet.style.backgroundColor = "rgb(230, 211, 100)";
...
function updateLightBeamCooldown(time) {
    ...
    if (cooldownDisplay) {
        cooldownDisplay.innerHTML = `<img src="dan1.webp" alt="Hồi chiêu" id="hinh-anh"           style="vertical-align: middle;"> ${time}s`;
    }
}
...
function createLightBeam() {
    ...
    lightBeam.style.width = character.offsetWidth + "px";
    lightBeam.style.height = character.offsetHeight + "px";
    lightBeam.style.backgroundImage = "url('dan1.webp')";
