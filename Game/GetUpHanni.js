...
function shootBullet() {
    ...
    if (soDan > 0) {
        ...
        bullet.style.backgroundColor = "rgb(250, 80, 200)";
...
function updateLightBeamCooldown(time) {
    ...
    if (cooldownDisplay) {
        cooldownDisplay.innerHTML = `<img src="hannilove.webp" alt="Hồi chiêu" id="hinh-anh" style="vertical-align: middle;"> ${time}s`;
    }
}
