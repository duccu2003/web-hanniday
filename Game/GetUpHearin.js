...
function shootBullet() {
    ...
    if (soDan > 0) {
        ...
        bullet.style.backgroundColor = "rgb(100, 200, 100)";
...
function updateLightBeamCooldown(time) {
    ...
    if (cooldownDisplay) {
        cooldownDisplay.innerHTML = `<img src="hearin.webp" alt="Hồi chiêu" id="hinh-anh" style="vertical-align: middle;"> ${time}s`;
    }
}
